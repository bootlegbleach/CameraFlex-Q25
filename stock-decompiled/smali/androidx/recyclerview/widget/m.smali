...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/m$b;->d()I
    ...
    invoke-interface {v5, v4}, Landroidx/recyclerview/widget/m$b;->c(Landroid/view/View;)I
    ...
    invoke-interface {v6, v4}, Landroidx/recyclerview/widget/m$b;->e(Landroid/view/View;)I
...
.method b(Landroid/view/View;I)Z
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/m$b;->d()I

    move-result v1

    iget-object v2, p0, Landroidx/recyclerview/widget/m;->a:Landroidx/recyclerview/widget/m$b;

    invoke-interface {v2}, Landroidx/recyclerview/widget/m$b;->b()I

    move-result v2

    iget-object v3, p0, Landroidx/recyclerview/widget/m;->a:Landroidx/recyclerview/widget/m$b;

    .line 2
    invoke-interface {v3, p1}, Landroidx/recyclerview/widget/m$b;->c(Landroid/view/View;)I

    move-result v3

    iget-object v4, p0, Landroidx/recyclerview/widget/m;->a:Landroidx/recyclerview/widget/m$b;

    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/m$b;->e(Landroid/view/View;)I

    move-result p1

    .line 3
    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/m$a;->e(IIII)V

    if-eqz p2, :cond_0

    .line 4
    iget-object p1, p0, Landroidx/recyclerview/widget/m;->b:Landroidx/recyclerview/widget/m$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/m$a;->d()V

    .line 5
    iget-object p1, p0, Landroidx/recyclerview/widget/m;->b:Landroidx/recyclerview/widget/m$a;

    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/m$a;->a(I)V

    .line 6
    iget-object p0, p0, Landroidx/recyclerview/widget/m;->b:Landroidx/recyclerview/widget/m$a;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/m$a;->b()Z
