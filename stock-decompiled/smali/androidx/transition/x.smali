...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sput-object v2, Landroidx/transition/x;->d:Ljava/lang/reflect/Method;
    ...
    .line 4
    :catch_0
    sput-boolean v0, Landroidx/transition/x;->e:Z

    .line 5
    :cond_0
    sget-object v0, Landroidx/transition/x;->d:Ljava/lang/reflect/Method;
...
.method static b(Landroid/view/ViewGroup;Z)V
    ...
    .line 1
    sget-object v0, Landroidx/transition/x;->a:Landroid/animation/LayoutTransition;
    ...
    sput-object v0, Landroidx/transition/x;->a:Landroid/animation/LayoutTransition;
    ...
    .line 10
    invoke-static {p1}, Landroidx/transition/x;->a(Landroid/animation/LayoutTransition;)V
    ...
    .line 13
    :cond_2
    sget-object p1, Landroidx/transition/x;->a:Landroid/animation/LayoutTransition;
    ...
    .line 15
    sget-boolean p1, Landroidx/transition/x;->c:Z
    ...
    sput-object p1, Landroidx/transition/x;->b:Ljava/lang/reflect/Field;
    ...
    .line 18
    :catch_0
    sput-boolean v1, Landroidx/transition/x;->c:Z

    .line 19
    :cond_4
    sget-object p1, Landroidx/transition/x;->b:Ljava/lang/reflect/Field;
